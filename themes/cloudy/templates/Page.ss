...
<html lang="en">
	<head>
        ...
        <!--Unsere CSS Dateien -->
       <!-- <link rel="stylesheet"href="themes/cloudy/thirdparty/fancybox/jquery.fancybox.css"/>   -->
        <link rel="stylesheet"href="themes/cloudy/thirdparty/fancybox/helpers/jquery.fancybox-thumbs.css"/>
        <link rel="stylesheet"href="themes/cloudy/thirdparty/stack/stack.css"/>
       ...
       <!--Unsere JavaScript Dateien -->
        <script src="themes/cloudy/thirdparty/fancybox/jquery.fancybox.pack.js"></script>
        <script src="themes/cloudy/thirdparty/fancybox/helpers/jquery.fancybox-thumbs.js"></script>
